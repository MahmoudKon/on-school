...
@section('content')
    ...
    <div class="col-12">
        ...
        <div class="card-header">
            ...
            <h4 class="card-title"><i class="la la-th"></i> @lang('site.table') @lang('site.'.$title)</h4>
             ...
             <div class="row">
              ...
              <div class="col-2">
                <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModalCenter">
                  <i class="ft-plus white"></i> @lang('site.createcategory')
                </button>
              ...
              <div class="col-2">
                <form action="{{ route('multidelete.categories') }}" method="get" >
                  @csrf
              ...
              <table class="table">
               ...
               @if($categories->count() > 0) 
                ...
                @foreach($categories as $index=>$category)
                  @include('dashboard.categories.row')
                 @endforeach   
