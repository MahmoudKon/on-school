<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="main-menu-content menu-accordion">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class="nav-item has-sub {{ is_active('cashes') }} ">
          <a href="#"><i class="la la-money"></i><span class="menu-title" data-i18n="nav.bootstrap_tables.main">@lang('site.cash') </span></a>
           <ul class="menu-content">
             <li class=""><a class="menu-item" href="{{ route('cashes.index') }}" data-i18n="nav.bootstrap_tables.table_basic">@lang('site.cash')</a>
             </li>
             </li>
           </ul>
        </li>
