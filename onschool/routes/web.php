    ...
    [
        ...
        Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'namespace' => 'Backend'], function () {
          ...
          //_____________________________________________________________________________________ 
           ...
           //ROUTE CASHSAFE 
            Route::resource('cashes', 'CashsafeController')->except('show');
            
            Route::post('/cashes/update', 'CashsafeController@update')->name('update.cash');
            
            Route::get('/cashes/delete/{id}', 'CashsafeController@destroy')->name('delete.cash');
            
            Route::get('/cash/search/', 'CashsafeController@rows')->name('cashes.rows');
            
            Route::get('/cashes/multidelete', 'CashsafeController@multidelete')->name('multidelete.cashes'); 
           //_____________________________________________________________________________________ 
